...
|---|---|---|---|
| 01 | [Portfolio Report](01_Portfolio_Report.md) | The story: idea → 4 versions → findings → failure log → results | Have 5 minutes — start here |
| 02 | [Case Study](02_Case_Study.md) | Full detail: model comparison, grounded fact-check tables, metrics, method and limitations | Have 15 minutes |
| 03 | [Annex A — Prompt History](03_Annex_A_Prompt_History.md) | The prompt across 5 versions, each change with its reason | Are interested in prompt engineering |
| 04 | [Annex B — Architecture](04_Annex_B_Architecture.md) | Plain-language "how it works": LLM vs code vs APIs division of labour | Want a non-technical overview |
| 05 | [Annex C — Eval Test Set](05_Annex_C_Eval_Test_Set.md) | The 10 synthetic listings with planted violations and the full answer key | Are interested in eval design |
| 06 | [Eval Workbook](06_Eval_Workbook.xlsx) | Raw scores: both models, all criteria, method notes, summary | Want the raw data |
| 07 | [Annex D — Cross-Judge Check](07_Annex_D_Cross_Judge_Check.md) | The bias control: blinded rival-family judging, 15/16 agreement, adjudicated ruling | Are interested in in eval rigour |
